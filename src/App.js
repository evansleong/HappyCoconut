...
import './App.css';
import open from "../src/Assets/Image/happy1-removebg-preview.png";
import close from "../src/Assets/Image/happy2-removebg-preview.png";
import Footer from "./Footer";
import backgroundMusic from "../src/Assets/Image/happy-happy-happy-cat.mp3";
...
function App() {
  ...
  useEffect(() => {
    ...
    closeButton.addEventListener("mouseenter", playNiganma);

    return () => {
      closeButton.removeEventListener("mouseenter", playNiganma);
    };
  }, []);
